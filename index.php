	...
	<section class="">
		...
		?>
			...
			<section class="caption">
				<h2 class="caption" style="text-align: center">Find You Dream Machines For Hire</h2>
				<h3 class="properties" style="text-align: center">Range Rovers - Mercedes Benz - Landcruisers - Hammers - Subarus </h3>
			</section>
